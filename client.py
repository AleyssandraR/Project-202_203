...
class GUI:
	...
	def layout(self,name):
		...
		self.entryMessage=Entry(self.labelBottom, bg='#2c3a50', fg='#eaecee', font=('Helvetica 13'))
		self.entryMessage.place(relwidth=0.74, relheight=0.06, rely=0.008, relx=0.011)
		self.entryMessage.focus()


		self.buttonMessage=Button(self.labelBottom, text='Send', font=('Helvetica 10 bold'), width=20, bg='pink', command=lambda:self.sendButton(self.entryMessage.get()))
